...
Early in the game, the economics phase is critically important. Decisions
made early on will have ramifications further into the game. Since it takes
many turns to build enough infrastructure to produce warships, early game
turns will consist mostly of building mines and colonies, with a bit of the
following deep space transport phase to emplace them.
...
\subsection{Phase tracker}

Like all wargames worthy of the name, each \tff\ turn is composed of phases.
Keeping track of the correct phase is important, but there is no player aid
for phase tracking shipping with the game.
