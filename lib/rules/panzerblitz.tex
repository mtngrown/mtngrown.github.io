...
\item [J -]\label{ref:halftrack-cat}
...
may not call for fire on the same turn as movement. Conversely,
having called for fire, may not subsequently move.
...
\subsection{Troop quality}

%%% http://boardgamegeek.com/article/17239467#17239467
...
Simply put: Russian fortifications are too strong. If emplaced on a hilltop,
it may not be possible to CAT attack at even close to 1:4 odds.
...
\item May not be used for CAT in original rules. See \ref{ref:halftrack-cat}-J.
