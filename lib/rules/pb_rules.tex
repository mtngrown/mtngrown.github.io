...
how it might be used with the optionally CAAT rules as well.
...
\begin{enumerate}
\item [A -] Range matters for certain frequencies.
\item [B -] Line of site conditions matter for certain frequencies.
\item [C -] Dispersal should have a non-zero chance of knocking out radio.
\end{enumerate}

All of these can be handled by die rolls.
...
in any hex between CP and battery.
\end{enumerate}
